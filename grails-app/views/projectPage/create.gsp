...
<html>
	...
	<body>
		<g:if test="${session.Account}">
			<a href="#create-projectPage" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<div id="create-projectPage" class="content scaffold-create" role="main">
				...
				<g:form url="[resource:projectPageInstance, action:'save']" >
					<fieldset class="form">
